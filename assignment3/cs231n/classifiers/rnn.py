...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        # backward pass
        dh, grads['W_vocab'], grads['b_vocab'] = temporal_affine_backward(dscores, cache['temporal_affine'])
    ...
    def sample(self, features, max_length=30):
        ...
        x = np.array([self._start]*N).reshape(N, 1)
        ...
        for i in range(max_length):
            ...
            idx = np.argmax(scores, axis=1).reshape(N, 1)
